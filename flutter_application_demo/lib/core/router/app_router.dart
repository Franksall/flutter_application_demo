...
final appRouter = GoRouter(
  ...
  routes: [
    ...
    GoRoute(
      ...
      pageBuilder: (context, state) => const MaterialPage(
        child: RecoveryFacialVerificationPage(),
      ),
    ),
    GoRoute(
      ...
      pageBuilder: (context, state) => const MaterialPage(
        child: RecoveryBiometricValidationPage(),
      ),
    ),
    GoRoute(
